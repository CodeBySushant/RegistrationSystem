...
CREATE TABLE IF NOT EXISTS BusinessRegistration (
  ...
  regNature VARCHAR(255),
  fatherName VARCHAR(255),
  grandfatherName VARCHAR(255),
  husbandName VARCHAR(255),
  motherInLawName VARCHAR(255),
  fatherInLawName VARCHAR(255),
  citizenAddress VARCHAR(500),
  businessType VARCHAR(255),
  propFatherName VARCHAR(255),
  propFatherAddress VARCHAR(500),
  propGrandfatherName VARCHAR(255),
  propGrandfatherAddress VARCHAR(500),
  propWifeName VARCHAR(255),
  propWifeAddress VARCHAR(500),
  remarks TEXT,
  proprietors JSON NULL, -- MySQL JSON column, or change to TEXT if your MySQL version lacks JSON support
  tippadiSignature VARCHAR(500),
  tippadiLevel VARCHAR(100),
  tippadiDate VARCHAR(50),
  tippadiName VARCHAR(255),
  tippadiPosition VARCHAR(255),
  approverSignature VARCHAR(500),
  approverName VARCHAR(255),
  approverPosition VARCHAR(255),
  applicantSignature VARCHAR(500),
  applicantNameSignature VARCHAR(255),
  voucherNo VARCHAR(100),
  voucherDate VARCHAR(50),
  voucherAmount VARCHAR(100),
  applicantName VARCHAR(255),
  applicantAddress VARCHAR(500),
  applicantCitizenship VARCHAR(100),
  applicantPhone VARCHAR(50),
