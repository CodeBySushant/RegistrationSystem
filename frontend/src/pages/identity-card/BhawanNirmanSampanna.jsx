...
export default function BhawanNirmanSampanna() {
  ...
  const addTransfer1 = () =>
    setForm((p) => ({
      ...p,
      transfers1: [...p.transfers1, emptyTransferRow()],
    }));
  ...
  const removeTransfer1 = (idx) =>
    setForm((p) => ({
      ...p,
      transfers1: p.transfers1.filter((_, i) => i !== idx),
    }));
  ...
  const addTransfer2 = () =>
    setForm((p) => ({
      ...
      transfers2: [
        ...p.transfers2,
        { from_name: "", to_name: "", recommender: "", approver: "" },
      ],
    }));
  ...
  const removeTransfer2 = (idx) =>
    setForm((p) => ({
      ...p,
      transfers2: p.transfers2.filter((_, i) => i !== idx),
    }));
      ...
      <form onSubmit={handleSubmit}>
        <div className="top-bar-title">
          ...
          <span className="top-right-bread">
            घर/जग्गा &gt; भवन निर्माण सम्पन्न प्रमाण-पत्र
          </span>
        </div>
        ...
        <div className="form-header-section">
          ...
          <div className="header-text">
            ...
            <p className="province-text red-text">
              भूमि व्यवस्थापन तथा भवन नियमन शाखा
            </p>
            <p className="province-text red-text">
              भवन तथा भवन संहिता र मापदण्ड कार्यान्वयन उपशाखा
            </p>
        ...
        <div className="form-body">
          <div className="intro-line">
            ...
            <input
              value={form.tole}
              onChange={(e) => setField("tole", e.target.value)}
              type="text"
          ...
          <div className="details-list">
            ...
            <div className="sub-detail-row">
              ...
              <input
                value={form.land_prev_local}
                onChange={(e) => setField("land_prev_local", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
              <label>वडा नं</label>
              <input
                value={form.land_prev_ward}
                onChange={(e) => setField("land_prev_ward", e.target.value)}
                type="text"
                className="dotted-input tiny-input"
              />
              <label>हल्का नं. / गा.पा. / वडा नं</label>
              <input
                value={form.land_prev_halqa}
                onChange={(e) => setField("land_prev_halqa", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
              <label>टोल</label>
              <input
                value={form.land_tol}
                onChange={(e) => setField("land_tol", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
            </div>
            ...
            <div className="sub-detail-row">
              ...
              <input
                value={form.land_kitta}
                onChange={(e) => setField("land_kitta", e.target.value)}
                type="text"
              ...
              <label>क्षेत्र</label>
              <input
                value={form.land_region}
                onChange={(e) => setField("land_region", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
              <label>उपक्षेत्र</label>
              <input
                value={form.land_subregion}
                onChange={(e) => setField("land_subregion", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
            </div>
            ...
            <div className="detail-item">
              ...
              <input
                ...
                onChange={(e) => setField("boundary_east", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
              पश्चिम{" "}
              <input
                ...
                onChange={(e) => setField("boundary_west", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
              उत्तर{" "}
              <input
                ...
                onChange={(e) => setField("boundary_north", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
              दक्षिण{" "}
              <input
                ...
                onChange={(e) => setField("boundary_south", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
            </div>
            ...
            <div className="detail-item">
              ...
              <input
                value={form.land_owner}
                onChange={(e) => setField("land_owner", e.target.value)}
                type="text"
                className="dotted-input long-input"
              />
            </div>
            ...
            <div className="detail-item">
              ...
              <input
                value={form.house_owner}
                onChange={(e) => setField("house_owner", e.target.value)}
                type="text"
                className="dotted-input long-input"
              />
            </div>
            ...
            <div className="detail-item">
              ...
              <input
                value={form.owner_parent}
                onChange={(e) => setField("owner_parent", e.target.value)}
                type="text"
                className="dotted-input long-input"
              />
            </div>
            ...
            <div className="detail-item">
              ...
              <input
                value={form.map_pass_no}
                onChange={(e) => setField("map_pass_no", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
              <label>मिति :</label>
            ...
            <div className="sub-detail-row pl-20">
              ...
              <input
                value={form.regularized_date}
                onChange={(e) => setField("regularized_date", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
              <label>सम्मन तला</label>
              <input
                value={form.regularized_floor_count}
                onChange={(e) =>
                  setField("regularized_floor_count", e.target.value)
                }
                type="text"
                className="dotted-input small-input"
              />
            ...
            <div className="detail-item">
              ...
              <input
                value={form.setback_distance}
                onChange={(e) => setField("setback_distance", e.target.value)}
                type="text"
                className="dotted-input small-input"
              />
              <label>सेट ब्याक छोड्को दुरी</label>
              <input
                value={form.setback_value}
                onChange={(e) => setField("setback_value", e.target.value)}
                type="text"
                className="dotted-input small-input"
              />
            </div>
            ...
            <div className="detail-item">
              ...
              <input
                value={form.electric_distance}
                onChange={(e) => setField("electric_distance", e.target.value)}
                type="text"
                className="dotted-input small-input"
              />
              <label>छाडेको दुरी</label>
              <input
                value={form.electric_left}
                onChange={(e) => setField("electric_left", e.target.value)}
                type="text"
                className="dotted-input small-input"
              />
              <label>भोल्ट</label>
              <input
                value={form.electric_volt}
                onChange={(e) => setField("electric_volt", e.target.value)}
                type="text"
                className="dotted-input small-input"
              />
            </div>
            ...
            <div className="detail-item">
              ...
              <input
                value={form.river_distance}
                onChange={(e) => setField("river_distance", e.target.value)}
                type="text"
                className="dotted-input small-input"
              />
              <label>छाडेको दुरी</label>
              <input
                value={form.river_left}
                onChange={(e) => setField("river_left", e.target.value)}
                type="text"
                className="dotted-input small-input"
              />
              ...
              <input
                ...
                onChange={(e) => setField("river_name", e.target.value)}
                type="text"
                className="dotted-input medium-input"
              />
            </div>
            ...
            <div className="detail-item">
              ...
              <input
                value={form.septic}
                onChange={(e) => setField("septic", e.target.value)}
                type="text"
                className="dotted-input long-input"
              />
            </div>
          ...
          <div className="signatures-grid mt-40">
            ...
            <div className="sig-box">
              <div className="line"></div>
              <p>स्थलगत निरिक्षकको सही</p>
            </div>
            <div className="sig-box">
              <div className="line"></div>
              <p>सिफारिस गर्नेको सही (इन्जिनियर)</p>
            </div>
            <div className="sig-box">
              <div className="line"></div>
              <p>प्रमाणपत्र दिनेको सही</p>
            </div>
          </div>
          ...
          <div className="transfer-tables-section mt-20">
                  ...
                  <tr key={i}>
                    ...
                    <td>
                      <input
                        value={t.date}
                        onChange={(e) =>
                          updateTransfer1(i, "date", e.target.value)
                        }
                    ...
                    <td>
                      <input
                        value={t.name}
                        onChange={(e) =>
                          updateTransfer1(i, "name", e.target.value)
                        }
                        className="table-input"
                      />
                    </td>
                    <td>
                      <input
                        value={t.recommender}
                        onChange={(e) =>
                          updateTransfer1(i, "recommender", e.target.value)
                        }
                        className="table-input"
                      />
                    </td>
                    <td>
                      <input
                        value={t.approver}
                        onChange={(e) =>
                          updateTransfer1(i, "approver", e.target.value)
                        }
                        className="table-input"
                      />
                    </td>
                    <td className="action-cell">
                      <button
                        type="button"
                        onClick={addTransfer1}
                        className="add-btn"
                      >
                        +
                      </button>
                      {form.transfers1.length > 1 && (
                        <button
                          type="button"
                          onClick={() => removeTransfer1(i)}
                        >
                          -
                        </button>
                      )}
            ...
            <p className="center-text bold-text mt-10">
              नामसारी गर्ने घर/जग्गाको विवरण
            </p>
            <table className="transfer-table">
              <thead>
                  ...
                  <tr key={i}>
                    ...
                    <td>
                      <input
                        value={t.from_name}
                        onChange={(e) =>
                          updateTransfer2(i, "from_name", e.target.value)
                        }
                        className="table-input"
                      />
                    </td>
                    <td>
                      <input
                        value={t.to_name}
                        onChange={(e) =>
                          updateTransfer2(i, "to_name", e.target.value)
                        }
                        className="table-input"
                      />
                    </td>
                    <td>
                      <input
                        value={t.recommender}
                        onChange={(e) =>
                          updateTransfer2(i, "recommender", e.target.value)
                        }
                        className="table-input"
                      />
                    </td>
                    <td>
                      <input
                        value={t.approver}
                        onChange={(e) =>
                          updateTransfer2(i, "approver", e.target.value)
                        }
                        className="table-input"
                      />
                    </td>
                    <td className="action-cell">
                      <button
                        type="button"
                        onClick={addTransfer2}
                        className="add-btn"
                      >
                        +
                      </button>
                      {form.transfers2.length > 1 && (
                        <button
                          type="button"
                          onClick={() => removeTransfer2(i)}
                        >
                          -
                        </button>
                      )}
