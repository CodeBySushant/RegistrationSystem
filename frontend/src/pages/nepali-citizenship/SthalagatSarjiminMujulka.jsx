...
export default function SthalagatSarjiminMujulka() {
  ...
  // FIX 1: Single controlled handleChange for all top-level inputs
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // FIX 5: Delay print to let success message render
  ...
  return (
    // FIX 5: Correct container class used throughout
    <form className="sarjimin-mujulka-container" onSubmit={handleSubmit} noValidate>
      {/* TOP BAR */}
      ...
      <div className="intro-paragraph">
        <p className="body-paragraph">
          ...
          नाताले नेपाली नागरिकता प्रमाण पत्र दिएमा फरक पर्ने छैन व्यहोरा फरक
          परेमा प्रचलित कानून बमोजिम हुने सजाय सहुँला बुझाउँला भनी हामी
          तपशिलका व्यक्तिहरु सही छाप गरी यो सर्जमिन मुचुल्का जिल्ला प्रशासन
          कार्यालय काठमाडौँ{" "}
          <input
              ...
              {form.tapsil.map((row, idx) => (
                <tr key={idx}>
                  ...
                  <td className="action-cell hide-print">
                    {idx === 0 ? (
                      <button type="button" className="add-btn" onClick={addTapsilRow}>
                        +
                      </button>
                    ) : (
                      <button
