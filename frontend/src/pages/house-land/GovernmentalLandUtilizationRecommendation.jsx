      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-body">
          <p className="body-paragraph">
            ...
            <input
              name="applicant_name_secondary"
              value={form.applicant_name_secondary}
              onChange={handleChange}
              className="inline-box-input medium-box"
              required
            />{" "}
            <span className="red">*</span> को छोरा{" "}
            <select
              name="child_prefix"
              className="inline-select"
            ...
            अनुसार मैले जिल्ला <span className="bold-text">काठमाडौँ</span>{" "}
            (साविक{" "}
            <input
              name="old_place_text"
              value={form.old_place_text}
              onChange={handleChange}
              className="inline-box-input medium-box"
            />{" "}
            <select
            ...
            <span className="bg-gray-text">{form.current_municipality}</span>{" "}
            वडा नं {form.current_ward_no} मा पर्ने तपशिल बमोजिमको चार किल्ला
            ...
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> भएको ऐलानी (दर्ता छुट) जग्गा...{" "}
            <input
              name="old_place_text_2"
              value={form.old_place_text_2 || ""}
              onChange={handleChange}
              className="inline-box-input medium-box"
            />
        ...
        <div className="tapashil-section">
          ...
          <p className="center-text" style={{ marginTop: 10 }}>
