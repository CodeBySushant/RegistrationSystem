      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="subject-section">
          <p>
            ...
            <span className="underline-text">
              पेस्की उपलब्ध गराईदिने सम्बन्धमा।
            </span>
          </p>
        </div>
        ...
        <div className="form-body">
          <p className="body-paragraph">
            प्रस्तुत बिषयमा यस{" "}
            <span className="bold-text">नागार्जुन नगरपालिका</span> चालु आ.व.
            <input
              name="budget_year"
            ...
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> मध्येबाट रु.
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> ( अक्षरेरुपी
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> रुपैया मात्र ) पेस्की मुक्तानी दिनु
            हुन अनुरोध गर्दछु।
          </p>
        </div>
