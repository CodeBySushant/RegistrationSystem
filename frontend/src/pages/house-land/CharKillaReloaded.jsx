...
const CharKillaReloaded = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("/api/forms/char-killa-reloaded", form);
      setLoading(false);
      if (res.status === 201) {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-body">
          <p className="body-paragraph">
            ...
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> ले आफ्नो नाममा मालपोत कार्यालय{" "}
            <span className="underline-text">{form.malpot_office_place}</span>{" "}
            <input
              ...
              className="inline-box-input medium-box"
            />{" "}
            दर्ता प्रमाणित रही आफ्नै हक भोग रहेको तपसिलमा उल्लेखित जग्गाको चार
            किल्ला खुलाई सिफारिस माग गर्नु भएकोमा ...
            <select
              name="place_type"
            ...
            निम्न अनुसार किल्ला रहेको हुँदा माग निवेदन अनुसार चार किल्ला खुलाई
                  ...
                  <tr key={i}>
                    ...
                    <td>
                      <select
                        ...
                        onChange={(e) =>
                          handlePlotChange(i, "type_of_place", e.target.value)
                        }
                      >
                    ...
                    <td>
                      <input
                        ...
                        value={r.ward_no}
                        onChange={(e) =>
                          handlePlotChange(i, "ward_no", e.target.value)
                        }
                    ...
                    <td>
                      <input
                        ...
                        value={r.seat_no}
                        onChange={(e) =>
                          handlePlotChange(i, "seat_no", e.target.value)
                        }
                        className="table-input"
                        required
                      />{" "}
                    ...
                    <td>
                      <input
                        ...
                        value={r.plot_no}
                        onChange={(e) =>
                          handlePlotChange(i, "plot_no", e.target.value)
                        }
                        className="table-input"
                        required
                      />{" "}
                    ...
                    <td>
                      <input
                        ...
                        value={r.area}
                        onChange={(e) =>
                          handlePlotChange(i, "area", e.target.value)
                        }
                        className="table-input"
                      />
                    </td>
                    <td>
                      <input
                        name={`east_plot_no_${i}`}
                        value={r.east_plot_no}
                        onChange={(e) =>
                          handlePlotChange(i, "east_plot_no", e.target.value)
                        }
                        className="table-input"
                        required
                      />{" "}
        ...
        <div className="declaration-section">
          <p className="body-paragraph">
            ...
            मार्फत न.पा. वडा कार्यालयमा उपस्थित भई दिएको छु । यसको आधिकारिकताको
            जिम्मेवारी म आफैं भएको व्यहोरा ...
            <select
            ...
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> दस्तखत...
          </p>
          <textarea
            name="notes"
            value={form.notes}
