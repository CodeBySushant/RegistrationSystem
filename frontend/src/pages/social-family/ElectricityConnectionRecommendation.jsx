  ...
  return (
    <form className="electricity-connection-container" onSubmit={handleSubmit}>
      ...
      <div className="addressee-section">
        <p className="bold-text">
          ...
          <input
            ...
            defaultValue="बुटवल पावर कम्पनी लिमिटेड"
          />
        </p>
      ...
      <div className="subject-section">
        <p>
          विषय: <span className="underline-text">बिजुली जडान सिफारिस।</span>
        </p>
      </div>
      ...
      <div className="form-body">
        ...
        <p>
          साविक{" "}
          <select name="land_old_unit_type" className="inline-select">
            <option value=""></option>
        ...
        <p>
          नागार्जुन नगरपालिका वडा नं. १ टोल{" "}
          <input
            name="land_tol"
            type="text"
            className="line-input medium-input"
        ...
        <ul className="declarations-list">
          <li>
            - पहिले विद्युत सप्लाई पिएन तथापि निजलाई नयाँ मीटर आवश्यक भएको हो।
          </li>
          <li>
            - विद्युत सप्लाई भएको हो छुट्टै मित्र भएकोले आवेदकलाई नयाँ मीटर दिन
            आवश्यक भएको हो।
          </li>
        </ul>
      </div>
