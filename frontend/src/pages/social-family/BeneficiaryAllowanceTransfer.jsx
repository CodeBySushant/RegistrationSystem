...
export default function BeneficiaryAllowanceTransfer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("/api/forms/beneficiary-allowance-transfer", form);
      setLoading(false);
      if (res.status === 201) {
      ...
      <div className="beneficiary-transfer-container">
        ...
        <div className="form-header-section">
          ...
          <h1 className="municipality-name">
            नागार्जुन नगरपालिका नगर कार्यपालिकाको कार्यालय
          </h1>
          <p className="address-text bold-text">
            काठमाडौँ जिल्ला बागमती प्रदेश
          </p>
        ...
        <div className="form-body">
          <p className="body-paragraph">
            ...
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> को लागि सामाजिक सुरक्षा भत्ता प्राप्त
            गर्न नियम अनुसार नवीकरण समेत गर्नुभएकाले निजको नाम यस
            <span className="bg-gray-text">नागार्जुन</span> को सामाजिक सुरक्षा
            भत्ता प्राप्त लाभग्राहीको मुख्य अभिलेखबाट नाम हटाई आर्थिक वर्ष
            <input
              name="fiscal_year_to"
              type="text"
              className="inline-box-input medium-box"
              required
            />{" "}
            <span className="red">*</span> चौमासिकबाट निजको निवेदन माग बमोजिम
            त्यस
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> को वडा नं.
            <input
              name="target_ward_no"
              type="text"
              ...
              required
            />{" "}
            <span className="red">*</span> बाट पाउनेगरि लगत कायम गरिदिनुहुन
            अनुरोध छ।
          </p>
        </div>
        ...
        <div className="table-section">
          <p>
            तालिका नं. - २ : (भत्ता स्थानान्तरणको लागि निवेदकले पेश गर्नुपर्ने
            विवरण ।)
          </p>
