...
const NewBirthVerification = () => {
  ...
  return (
    <form
      className="birth-verification-english-container"
    ...
    >
      ...
      <div className="form-header-section">
        ...
        <div className="header-text">
          ...
          <h3 className="ward-title-np">
            १ नं वडा कार्यालय{" "}
            <span className="ward-title-en">(1 No. Ward Office)</span>
          </h3>
          <p className="address-text-np">
            काठमाडौँ जिल्ला{" "}
            <span className="address-text-en">(Kathmandu District)</span>
          </p>
          <p className="province-text-np">
            बागमती प्रदेश{" "}
            <span className="province-text-en">(Bagmati Province)</span>
          </p>
      ...
      <div className="meta-data-row">
        <div className="meta-left">
          <p>
            Letter No. : <span className="bold-text">{form.letter_no}</span>
          </p>
          <p>
            Ref No.:{" "}
            <input
      ...
      <div className="intro-paragraph">
        <p>
          ...
          <select
            className="inline-select"
            value={form.subject_person_prefix}
            onChange={(e) => setField("subject_person_prefix", e.target.value)}
          >
            <option>Mr.</option>
            <option>Mrs.</option>
          </select>
          <input
            value={form.subject_person_name}
            onChange={(e) => setField("subject_person_name", e.target.value)}
            type="text"
            className="line-input medium-input"
          />{" "}
          ...
          <tbody>
            <tr>
              ...
              <td className="input-cell">
                <input
                  ...
                  onChange={(e) => setField("full_name_np", e.target.value)}
                  type="text"
            ...
            <tr>
              ...
              <td className="input-cell flex-cell">
                ...
                <input
                  value={form.dob_ad}
                  onChange={(e) => setField("dob_ad", e.target.value)}
                  type="text"
                  className="table-input medium-input"
                />
            ...
            <tr>
              ...
              <td className="input-cell address-grid">
                <select
                  ...
                  onChange={(e) => setField("perm_province", e.target.value)}
                  className="table-select"
                >
                ...
                <select
                  ...
                  onChange={(e) => setField("perm_district", e.target.value)}
                  className="table-select"
                >
                  <option>District</option>
                </select>
                <input
                  value={form.perm_palika}
                  onChange={(e) => setField("perm_palika", e.target.value)}
                  type="text"
                  className="table-input"
                  placeholder="पालिका"
                />
                <input
                  ...
                  onChange={(e) => setField("perm_ward", e.target.value)}
                  type="text"
                  className="table-input"
                  placeholder="वडा"
                />
            ...
            <tr>
              ...
              <td className="input-cell address-grid">
                <select
                  value={form.perm_palika_en}
                  onChange={(e) => setField("perm_palika_en", e.target.value)}
                  className="table-select"
                >
                  <option>Palika</option>
                </select>
                <select
                  value={form.perm_ward_en}
                  onChange={(e) => setField("perm_ward_en", e.target.value)}
                  className="table-select"
                >
                  <option>WardNo</option>
                </select>
                <input
                  type="text"
                  className="table-input"
            ...
            <tr>
              ...
              <td className="input-cell address-grid-5">
                ...
                <input
                  value={form.birth_palika}
                  onChange={(e) => setField("birth_palika", e.target.value)}
                  type="text"
                  className="table-input"
                  placeholder="पालिका"
                />
                <input
                  value={form.birth_ward}
                  onChange={(e) => setField("birth_ward", e.target.value)}
                  type="text"
                  className="table-input"
                  placeholder="वडा"
                />
                <input
                  ...
                  onChange={(e) => setField("birth_place_name", e.target.value)}
                  type="text"
                  className="table-input"
            ...
            <tr>
              ...
              <td className="input-cell address-grid-5">
                <select
                  value={form.birth_palika_en}
                  onChange={(e) => setField("birth_palika_en", e.target.value)}
                  className="table-select"
                >
                  <option>Palika</option>
                </select>
                <select
                  value={form.birth_ward_en}
                  onChange={(e) => setField("birth_ward_en", e.target.value)}
                  className="table-select"
                >
                  <option>WardNo</option>
                </select>
            ...
            {/* Father's Details */}
            <tr>
              <td rowSpan="3" className="label-cell bg-gray section-header">
                बाबुको विवरण (Father's Details)
              </td>
              <td className="input-cell flex-row">
                <span className="sub-label">पूरा नाम:</span>
                <input
                  value={form.father_full_name_np}
                  onChange={(e) =>
                    setField("father_full_name_np", e.target.value)
                  }
                  type="text"
                  className="table-input"
                />
            ...
            <tr>
              <td className="input-cell flex-row">
                ...
                <input
                  value={form.father_full_name_en}
                  onChange={(e) =>
                    setField("father_full_name_en", e.target.value)
                  }
                  type="text"
                  className="table-input"
                />
            ...
            <tr>
              <td className="input-cell flex-row">
                ...
                <select
                  value={form.father_document_type}
                  onChange={(e) =>
                    setField("father_document_type", e.target.value)
                  }
                  className="table-select medium-select"
                >
                  <option>Select Document Type</option>
                </select>
                <input
                  value={form.father_document_no}
                  onChange={(e) =>
                    setField("father_document_no", e.target.value)
                  }
                  type="text"
                  className="table-input"
                />
            ...
            <tr>
              ...
              <td className="input-cell flex-row">
                <span className="sub-label">पूरा नाम:</span>
                <input
                  value={form.mother_full_name_np}
                  onChange={(e) =>
                    setField("mother_full_name_np", e.target.value)
                  }
                  type="text"
                  className="table-input"
                />
            ...
            <tr>
              <td className="input-cell flex-row">
                <span className="sub-label en-label">Full Name:</span>
                <input
                  value={form.mother_full_name_en}
                  onChange={(e) =>
                    setField("mother_full_name_en", e.target.value)
                  }
                  type="text"
                  className="table-input"
                />
            ...
            <tr>
              <td className="input-cell flex-row">
                <span className="sub-label">परिचय पत्र(Document):</span>
                <select
                  value={form.mother_document_type}
                  onChange={(e) =>
                    setField("mother_document_type", e.target.value)
                  }
                  className="table-select medium-select"
                >
                  <option>Select Document Type</option>
                ...
                <input
                  value={form.mother_document_no}
                  onChange={(e) =>
                    setField("mother_document_no", e.target.value)
                  }
                  type="text"
                  className="table-input"
                />
