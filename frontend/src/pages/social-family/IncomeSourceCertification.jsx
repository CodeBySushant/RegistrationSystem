    ...
    <div className="income-source-container">
      ...
      <div className="form-body">
        <p className="body-paragraph">
          ...
          ले दिनु भएको निवेदन अनुसार निज निवेदकको आय श्रोत तपशिल बमोजिम रहेको
          व्यहोरा सिफारिस साथ सादर अनुरोध गर्दछु ।
        </p>
      </div>
          ...
          <table className="income-table">
            ...
            <tbody>
              <tr>
                <td>१</td>
                <td>
                  <input type="text" className="table-input" required />{" "}
