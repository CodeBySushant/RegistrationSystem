...
const ThreeGenerationCertificate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("/api/forms/three-generation-certificate", form);
      setLoading(false);
      if (res.status === 201) {
    ...
    <form className="three-generation-container" onSubmit={handleSubmit}>
      ...
      <div className="form-body">
        <p className="body-paragraph">
          ...
          <span className="bold-text ml-20">{form.municipality_name}</span> वडा
          नं. <span className="bold-text">१</span> (साविक
          <input
          ...
          <select
            ...
            onChange={(e) => setField("resident_prefix", e.target.value)}
                ...
                <tr key={i}>
                  ...
                  <td>
                    <input
                      value={r.plot_no}
                      onChange={(e) =>
                        onLandChange(i, "plot_no", e.target.value)
                      }
                  ...
                  <td>
                    <input
                      value={r.seat_no}
                      onChange={(e) =>
                        onLandChange(i, "seat_no", e.target.value)
                      }
                      className="table-input"
                    />
                  </td>
                  ...
                  <td className="action-cell">
                    <button type="button" className="add-btn" onClick={addLand}>
                      +
                    </button>
                    {lands.length > 1 && (
                      <button
              ...
              {generations.map((g, i) => (
                <tr key={i}>
                  ...
                  <td>
                    <input
                      value={g.name}
                      onChange={(e) => onGenChange(i, "name", e.target.value)}
                      className="table-input"
                      required
                    />{" "}
                    <span className="red-asterisk in-cell">*</span>
                  ...
                  <td>
                    <input
                      value={g.relation}
                      onChange={(e) =>
                        onGenChange(i, "relation", e.target.value)
                      }
                      className="table-input"
                      required
                    />{" "}
                  ...
                  <td>
                    <input
                      value={g.citizenship_no}
                      onChange={(e) =>
                        onGenChange(i, "citizenship_no", e.target.value)
                      }
                      className="table-input"
                      required
                    />{" "}
                  ...
                  <td>
                    <input
                      value={g.issue_date}
                      onChange={(e) =>
                        onGenChange(i, "issue_date", e.target.value)
                      }
                      className="table-input"
                      required
                    />{" "}
                  ...
                  <td>
                    <input
                      value={g.district}
                      onChange={(e) =>
                        onGenChange(i, "district", e.target.value)
                      }
                      className="table-input"
                      required
                    />{" "}
                  ...
                  <td className="action-cell">
                    <button type="button" className="add-btn" onClick={addGen}>
                      +
                    </button>
