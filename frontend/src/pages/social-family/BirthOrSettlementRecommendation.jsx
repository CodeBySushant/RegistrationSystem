...
const BirthOrSettlementRecommendation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("/api/forms/birth-settlement-recommendation", form);
      setLoading(false);
      if (res.status === 201) {
        ...
        <div className="form-body">
          <p className="body-paragraph">
            ...
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> को जन्म साविक जिल्ला
            <input
              name="birth_district"
              type="text"
              className="inline-box-input medium-box"
            ...
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> गा मिति
            <input
              name="birth_date"
              type="text"
              className="inline-box-input medium-box"
            ...
            <input
              ...
              defaultValue="२०८२-०८-०६"
            />{" "}
            देखि यस <span className="bold-text">नागार्जुन</span> गा बसोबास गर्दै
            आएकोले निजको जन्म/बसोबास प्रमाणित गरिपाउँ भनि{" "}
            <span className="bg-gray-text">नागार्जुन नगरपालिका</span> , १ नं वडा
            कार्यालयमा मिति २०८२-०८-०६ गा दिनु भएको निवेदन बमोजिम श्री
            <input
              name="parent_name"
              type="text"
              className="inline-box-input medium-box"
            ...
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> गा जन्म भई हाल{" "}
            ...
            <input
              ...
              required
            />{" "}
            <span className="red">*</span> गा बसोबास गर्दै आएको र निजको जन्म
            मिति
            <input
              ...
              defaultValue="२०८२-०८-०६"
            />{" "}
            गा भएको हुँदा निजको जन्म/बसोबास प्रमाणित गरिएको व्यहोरा अनुरोध छ ।
          </p>
        </div>
