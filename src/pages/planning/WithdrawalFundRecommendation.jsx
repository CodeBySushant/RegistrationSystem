      ...
      <div className="form-body">
        <p className="body-paragraph">
          ...
          <input
            type="text"
            className="long-box"
            defaultValue="नागार्जुन नगरपालिका नगर"
          />
          सभाबाट स्वीकृत आ.व.{" "}
          <input type="text" className="long-box" defaultValue="२०८२/८३को" />
          स्वीकृत वार्षिक बजेट तथा कार्यक्रम अन्तर्गत विनियोजन भएको बजेट बाट
          ...
          <span>
            <input
              ...
              type="text"
              className="inline-box-input medium-box fixed-text required"
              placeholder="अध्यक्ष"
              required
            />
          </span>{" "}
