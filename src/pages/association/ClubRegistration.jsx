...
export default function ClubRegistration() {
  ...
  return (
    <div className="crp-page">
      ...
      <div className="crp-paper">
        <div className="crp-letterhead">
          ...
          <div className="crp-head-text">
            ...
            <div className="crp-head-sub">नागार्जुन, काठमाडौं <br/> बागमती प्रदेश, नेपाल</div>
          </div>

          <div className="crp-head-meta">
            <div className="crp-meta-line">
              मिति : <input type="text" name="date" value={form.date} onChange={handleChange} className="crp-small-input" />
            </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="crp-to-block">
            <span>श्री</span>
            <input type="text" name="toName" className="crp-long-input" value={form.toName} onChange={handleChange} />
            <span>ज्यु,</span>
            <br />
          ...
          <p className="crp-body">
            ...
            <span className="crp-bold">{form.municipality}</span> वडा नं.{" "}
            <input type="text" name="wardNo" className="crp-tiny-input" value={form.wardNo} onChange={handleChange} /> मा स्थायी बसोबास रहने{" "}
            <input type="text" name="residentName" className="crp-medium-input" placeholder="व्यक्तिको नाम" value={form.residentName} onChange={handleChange} /> ले{" "}
            <input type="text" name="clubName" className="crp-medium-input" placeholder="क्लबको नाम" value={form.clubName} onChange={handleChange} /> नामक क्लब दर्ता सिफारिस गरी पाउँ भनी यस वडा कार्यालयमा निवेदन दिएको हुँदा उक्त क्लब{" "}
            <input type="text" name="clubAddress" className="crp-medium-input" placeholder="ठेगाना / स्थान" value={form.clubAddress} onChange={handleChange} /> मा दर्ता गर्न सिफारिस साथ अनुरोध गरिएको छ ।
          </p>

          <div className="crp-blank-area" />

          <div className="crp-sign-top">
            <input type="text" name="signerName" className="crp-sign-name" placeholder="नाम, थर" value={form.signerName} onChange={handleChange} />
            <select className="crp-post-select" name="signerDesignation" value={form.signerDesignation} onChange={handleChange}>
      ...
      <footer className="crp-footer">© सर्वाधिकार सुरक्षित नामगुन नगरपालिकाः</footer>
    </div>
  );
}
