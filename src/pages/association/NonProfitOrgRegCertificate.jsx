  ...
  return (
    <div className="nprc-page">
      <header className="nprc-topbar">
        ...
        <div className="nprc-top-right">अवलोकन पृष्ठ / गैर नाफामूलक संस्था दर्ता प्रमाण पत्र</div>
      </header>
      ...
      <div className="nprc-paper">
        <div className="nprc-letterhead">
          ...
          <div className="nprc-head-text">
            ...
            <div className="nprc-head-sub">नागार्जुन, काठमाडौं <br/> बागमती प्रदेश, नेपाल</div>
          </div>

          <div className="nprc-head-meta">
            <div>
              पत्र संख्या :
              <select name="fiscalYear" value={form.fiscalYear} onChange={handleChange} className="nprc-fy-select">
                <option>2082/83</option>
                <option>2081/82</option>
                <option>2080/81</option>
              </select>
            </div>
            <div className="nprc-meta-line">मिति : <input type="text" name="date" className="nprc-small-input" value={form.date} onChange={handleChange} /></div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="nprc-subject-block">
            <div className="nprc-subject-wrap">
              ...
              <span className="nprc-subject-text">गैर नाफामूलक संस्था दर्ता प्रमाण पत्र ।</span>
            </div>
          ...
          <section className="nprc-section nprc-cert-section">
            <p className="nprc-body">ऐसागर्ने अन्य निकायबाट स्वीकृत वा इजाजत लिनु पर्ने छ । साथै यो प्रमाण पत्र सावधानी नवीकरण गर्नु पर्नेछ ।</p>
          ...
          <div className="nprc-sign-top">
            <input type="text" name="signerName" className="nprc-sign-name" placeholder="नाम, थर" value={form.signerName} onChange={handleChange} />
            <select name="signerDesignation" className="nprc-post-select" value={form.signerDesignation} onChange={handleChange}>
      ...
      <footer className="nprc-footer">© सर्वाधिकार सुरक्षित नामगुन नगरपालिकाः</footer>
    </div>
  );
}
