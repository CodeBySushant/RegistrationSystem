...
export default function BulkLoanRecommendation() {
  ...
  return (
    <div className="blr-page">
      ...
      <div className="blr-paper">
        <div className="blr-letterhead">
          ...
          <div className="blr-head-meta">
            <div className="blr-meta-line">
              मिति : <input type="text" name="date" value={form.date} onChange={handleChange} className="blr-small-input" />
            </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="blr-to-block">
            <span>श्री</span>
            <input type="text" name="toName" className="blr-long-input" value={form.toName} onChange={handleChange} />
            <span>ज्यु,</span>
            <br />
            <input type="text" name="toSecondLine" className="blr-long-input blr-to-second" value={form.toSecondLine} onChange={handleChange} />
          </div>
          ...
          <p className="blr-body">
            प्रस्तुत विषयमा <span className="blr-bold">नागार्जुन नगरपालिका</span> वडा नं.{" "}
            <input type="text" name="wardNo" className="blr-tiny-input" value={form.wardNo} onChange={handleChange} /> (साबिक{" "}
            <input type="text" name="prevLocationType" className="blr-small-inline" value={form.prevLocationType} onChange={handleChange} /> वडा नं.{" "}
            <input type="text" name="prevLocationWardNo" className="blr-tiny-input" value={form.prevLocationWardNo} onChange={handleChange} />) मा कार्यलय स्थापना गरी आफ्नो क्षेत्रवासीहरुले सहकारी मार्फत ऋण प्रवाह गर्न कार्यलय स्थापना गर्न इच्छुक{" "}
            <input type="text" name="cooperativeName" className="blr-medium-input" value={form.cooperativeName} onChange={handleChange} /> सहकारी संस्थाले यस वडा कार्यालयमा निवेदन पेश गरेको हुँदा यस कार्यालयमा दर्ता भई आवश्यक कागजातका आधारमा कार्यलय स्थापना गरी थोक कर्जा प्रवाह गर्न नेपाल सरकार{" "}
            <input type="text" name="governmentAgency" className="blr-medium-input" value={form.governmentAgency} onChange={handleChange} /> बाट थोक कर्जा प्राप्त गर्नसकिने व्यवस्था मिलाइदिनुहुन सिफारिससाथ अनुरोध गरिएको छ ।
          </p>

          <div className="blr-blank-area" />

          <div className="blr-sign-top">
            <input type="text" className="blr-sign-name" name="signerName" placeholder="नाम, थर" value={form.signerName} onChange={handleChange} />
            <select className="blr-post-select" name="signerDesignation" value={form.signerDesignation} onChange={handleChange}>
          ...
          <div className="blr-submit-row">
            <button className="blr-submit-btn" type="submit" disabled={submitting}>
      ...
      <footer className="blr-footer">© सर्वाधिकार सुरक्षित नामगुन नगरपालिकाः</footer>
    </div>
  );
}
