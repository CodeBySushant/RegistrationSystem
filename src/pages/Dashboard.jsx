...
// Example weekly data (replace with real-time values from API/state)
const WEEKLY_PIE_DATA = [
  ["service", "score"],
  ["दर्ता", 4],
  ["चलानी", 91],
  ["सूचना", 0],
...
const Dashboard = () => {
  return (
    <div className="p-4 sm:p-8 space-y-8">
      <div className="flex justify-between items-center border-b pb-4">{/* header area if needed */}</div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          ...
          <div className="w-full h-64 bg-gray-50 border border-gray-200 rounded-lg flex items-center justify-center">
            <Chart
              ...
              loader={<div className="text-gray-400 text-sm">Loading chart…</div>}
            />
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-around h-80">
            ...
            <div className="mt-4 md:mt-0 md:ml-8 text-sm space-y-2">
              <div className="flex items-center">
                <span className="w-3 h-3 rounded-full bg-purple-500 mr-2" /> नेपाली नागरिकता
              </div>
              <div className="flex items-center">
                <span className="w-3 h-3 rounded-full bg-pink-500 mr-2" /> घर / जग्गा जमिन
              </div>
              <div className="flex items-center">
                <span className="w-3 h-3 rounded-full bg-blue-500 mr-2" /> संघ / संस्था
              </div>
              <div className="flex items-center">
                <span className="w-3 h-3 rounded-full bg-yellow-500 mr-2" /> व्यवसाय दर्ता
              </div>
              <div className="flex items-center">
