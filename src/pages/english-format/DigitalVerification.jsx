...
const DigitalVerification = () => {
  ...
  const validate = () => {
    const required = [
      "applicantNameBody", "guardianName", "motherName",
    ...
    const check = ["applicantNameBody","guardianName","motherName","contactName","contactDesignation","contactNumber","contactEmail","designation","applicantName","applicantAddress","applicantCitizenship","applicantPhone"];
    for (let k of check) {
    ...
    <div className="digital-verification-container">
      <form onSubmit={handleSubmit}>
        ...
        <div className="subject-line">
          <strong>Subject: <u>DIGITAL VERIFICATION CERTIFICATE</u></strong><br/>
        ...
        <p className="certificate-body">
          ...
          (Previously
          <input type="text" name="prevDesignation" placeholder="e.g., VDC" value={formData.prevDesignation} onChange={handleChange} />
          Ward No.
          ...
          <input type="text" name="country" value={formData.country} onChange={handleChange} /> for the purpose of
          <input type="text" name="purpose" value={formData.purpose} onChange={handleChange} /> for
          <input type="text" name="destination" value={formData.destination} onChange={handleChange} /> are genuine and authentic. If you have any inquiry, contact:
        </p>
