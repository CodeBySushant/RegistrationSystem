...
const MarriageCertificate = () => {
  ...
  const validate = () => {
    const required = [
      "groomName","groomGuardianName","groomMotherName",
      "brideName","brideGuardianName","brideMotherName",
      "marriageDateBS","applicantName","applicantAddress","applicantCitizenship","applicantPhone","designation",
      "groomCitizenship","brideCitizenship"
    ];
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/forms/marriage-certificate", {
        method: "POST",
    ...
    <div className="marriage-certificate-container">
      <form onSubmit={handleSubmit}>
        ...
        <div className="subject-line">
          <strong>Subject: <u>Marriage Certificate</u></strong><br/>
          <strong><u>To Whom It May Concern</u></strong>
        </div>

        <p className="certificate-body">
          This is to certify that
          <select name="groomTitle" value={formData.groomTitle} onChange={handleChange}><option>Mr.</option><option>Mrs.</option><option>Ms.</option></select>
          <input type="text" name="groomName" placeholder="Groom's Name" value={formData.groomName} onChange={handleChange} required />,
          <select name="groomRelation" value={formData.groomRelation} onChange={handleChange}><option>grandson</option><option>son</option></select>
          of
          <select name="groomGuardianTitle" value={formData.groomGuardianTitle} onChange={handleChange}><option>Mr.</option></select>
          ...
          and
          <select name="groomMotherTitle" value={formData.groomMotherTitle} onChange={handleChange}><option>Mrs.</option></select>
          ...
          , (Previously
          <select name="prevDesignation" value={formData.prevDesignation} onChange={handleChange}><option>ward no</option><option>VDC</option></select>
          <input type="text" name="prevWardNo" placeholder="Ward" value={formData.prevWardNo} onChange={handleChange} />),
          <input type="text" name="prevDistrict" value={formData.prevDistrict} onChange={handleChange} /> , <input type="text" name="district" value={formData.district} onChange={handleChange} />,
          Nepal is married to
          <select name="brideTitle" value={formData.brideTitle} onChange={handleChange}><option>Miss.</option><option>Mrs.</option></select>
          <input type="text" name="brideName" placeholder="Bride's Name" value={formData.brideName} onChange={handleChange} required />,
          <select name="brideRelation" value={formData.brideRelation} onChange={handleChange}><option>granddaughter</option><option>daughter</option></select>
          of
          <select name="brideGuardianTitle" value={formData.brideGuardianTitle} onChange={handleChange}><option>Mr.</option></select>
          ...
          and
          <select name="brideMotherTitle" value={formData.brideMotherTitle} onChange={handleChange}><option>Mrs.</option></select>
          ...
          , dated on
          <input type="text" name="marriageDateBS" value={formData.marriageDateBS} onChange={handleChange} /> B.S. (
          <input type="date" name="marriageDateAD" value={formData.marriageDateAD} onChange={handleChange} /> A.D.), according to their social custom.
        </p>
