...
const EconomicStatus = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/forms/economic-status", {
        method: "POST",
    ...
    <div className="economic-status-container">
      <form onSubmit={handleSubmit}>
        ...
        <div className="subject-line">
          <strong>Subject: <u>Economic Status Verification</u></strong><br/>
        ...
        <p className="certificate-body">
          ...
          <select name="relation" value={formData.relation} onChange={handleChange}>
            <option>Grand Son</option><option>Son</option><option>Daughter</option><option>Grand Daughter</option>
          </select>
          of
          <select name="grandFatherTitle" value={formData.grandFatherTitle} onChange={handleChange}><option>Mr.</option></select>
          ...
          , Son of
          <select name="sonOfTitle" value={formData.sonOfTitle} onChange={handleChange}><option>Mr.</option></select>
          ...
          <input type="text" name="district2" value={formData.district2} onChange={handleChange} /> District,
          <input type="text" name="province" value={formData.province} onChange={handleChange} />, <input type="text" name="country" value={formData.country} onChange={handleChange} />
          was retired from
          ...
          <input type="text" name="retirementDateBS" value={formData.retirementDateBS} onChange={handleChange} /> B.S. (
          <input type="date" name="retirementDateAD" value={formData.retirementDateAD} onChange={handleChange} /> A.D.).
        </p>
